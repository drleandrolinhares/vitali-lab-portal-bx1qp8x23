                ...
                <td>
                  ...
                  <div className="flex justify-between items-start mb-6 print:mb-8">
                    ...
                    <div className="text-right">
                      <p className="text-sm font-medium text-slate-500 print:text-slate-500">
                        Status
                      </p>
                      <p
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6 p-4 bg-slate-50 rounded-lg border border-slate-100 print:bg-slate-50/50 print:border-slate-200 print:border">
                    <div>
