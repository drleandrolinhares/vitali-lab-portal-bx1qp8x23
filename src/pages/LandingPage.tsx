      ...
      <main>
        ...
        <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden flex items-center justify-center">
          <div className="absolute inset-0 z-0 opacity-30">
            <img
              src="https://img.usecurling.com/p/1920/1080?q=dental%20prosthesis&color=black"
              alt="Prosthesis background"
              className="w-full h-full object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-background via-background/80 to-transparent" />
          </div>
          <div className="container relative z-10 mx-auto px-4 sm:px-6 text-center max-w-4xl">
            <h1 className="text-5xl md:text-7xl font-display font-bold tracking-tight mb-6 text-foreground leading-tight">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="rounded-full px-8 h-14 text-base w-full sm:w-auto bg-transparent hover:bg-muted text-foreground border-border"
              >
        ...
        <section id="solucoes" className="py-24 bg-muted/20">
          <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
            ...
            <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
              {/* Cerâmicas */}
              <div className="group relative overflow-hidden rounded-3xl bg-card border border-border transition-all hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/10">
                <div className="aspect-[4/3] overflow-hidden">
                  <img
                    src="https://img.usecurling.com/p/800/600?q=ceramic%20teeth&color=black"
              ...
              <div className="group relative overflow-hidden rounded-3xl bg-card border border-border transition-all hover:border-primary/50 hover:shadow-2xl hover:shadow-primary/10">
                <div className="aspect-[4/3] overflow-hidden">
                  <img
                    src="https://img.usecurling.com/p/800/600?q=dental%20acrylic&color=black"
                    alt="Studio Acrílico"
                    className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-90"
                  />
                </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-8 order-2 lg:order-1">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-muted border border-border text-sm font-medium text-foreground">
              ...
              <div className="relative order-1 lg:order-2">
                ...
                <img
                  src="https://img.usecurling.com/p/800/800?q=dentist%20patient&color=black"
                  alt="Atendimento Humanizado"
                  className="relative z-10 rounded-3xl object-cover border border-border shadow-2xl aspect-square lg:aspect-auto"
                />
              </div>
            </div>
          </div>
