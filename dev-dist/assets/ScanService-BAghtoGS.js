import { t as Calendar$1 } from "./calendar-DuROYlB0.js";
import { a as SelectValue, i as SelectTrigger, n as SelectContent, r as SelectItem, t as Select } from "./select-CyQzQ-HX.js";
import { a as endOfWeek, c as isSameDay, l as addWeeks, n as isSameMonth, o as startOfMonth, r as isBefore, s as endOfMonth, t as Calendar, u as addDays } from "./calendar-BR_yOHjG.js";
import { t as Clock } from "./clock-CqtZm64c.js";
import { t as Funnel } from "./funnel-C6a8NTPI.js";
...
import { n as DropdownMenuCheckboxItem, r as DropdownMenuContent, s as DropdownMenuTrigger, t as DropdownMenu } from "./dropdown-menu-Cdgg9BIm.js";
import { n as PopoverContent, r as PopoverTrigger, t as Popover } from "./popover-Dc787iH9.js";
...
function ScanSidebar({ currentDate, setCurrentDate }) {
...
function ScanHeader({ view, setView, activeTab, setActiveTab, filters, setFilters }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "bg-slate-100/80 p-1 rounded-lg flex items-center h-11 border border-slate-200",
				children: [
					"day",
					"week",
					"month"
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenu, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenuTrigger, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
						className: "w-full sm:w-[160px] h-11 text-xs font-bold uppercase border-slate-200 bg-white",
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [
					...
					className: cn("px-5 pb-3 pt-4 text-[11px] whitespace-nowrap font-black uppercase border-b-[3px] transition-colors tracking-wide", activeTab === tab ? "border-[#D6A75A] text-[#1A233A]" : "border-transparent text-slate-400 hover:text-slate-600 hover:border-slate-200"),
					children: tab
				}, tab))
			})
		})]
...
function SlotItem({ slot, dateStr, bookings, blocks, filters, isStaff, currentUserId, onSlotClick, onBookingClick }) {
	const overlappingBlock = checkBlockOverlap(slot.start, slot.end, dateStr, blocks);
	if (overlappingBlock && filters.showBlocks) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "h-[72px] border-b border-slate-100 p-1.5 group",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "w-full h-full rounded-md bg-slate-50 text-slate-400 border border-slate-200 border-dashed flex items-center justify-center text-[10px] font-bold uppercase cursor-not-allowed",
			children: "Bloqueado"
		})
	});
	const overlappingBooking = bookings.find((b) => b.start_time.substring(0, 5) < slot.end && b.end_time.substring(0, 5) > slot.start);
	if (overlappingBooking && filters.showBookings) {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "h-[72px] border-b border-slate-100 p-1.5",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				onClick: () => canViewDetails && onBookingClick(overlappingBooking),
				className: cn("w-full h-full rounded-md border shadow-sm select-none transition-colors relative flex flex-col justify-center px-3", canViewDetails ? "bg-[#1A233A] text-white border-[#1A233A] cursor-pointer hover:bg-[#2A344A]" : "bg-slate-100 text-slate-500 border-slate-200 cursor-not-allowed opacity-80"),
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-1.5 mb-0.5 opacity-80",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock, { className: "w-3 h-3" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "w-full h-full rounded-md border border-transparent group-hover:border-dashed group-hover:border-slate-300 group-hover:bg-slate-50 flex items-center justify-center transition-all",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
				className: "text-[10px] font-bold text-transparent group-hover:text-slate-400 tracking-wider",
				children: [
					slot.start,
					" - ",
					slot.end
...
function ScanCalendarViews({ view, currentDate, bookings, blocks, settings, filters, isStaff, currentUserId, activeTab, onSlotClick, onBookingClick, setCurrentDate, setView }) {
	...
	if (view === "month") {
		...
		if (!mDays.some((d) => {
			...
			className: "h-full w-full min-h-[400px] flex items-center justify-center border border-slate-200 shadow-sm bg-white rounded-xl",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-sm font-black text-slate-500 uppercase tracking-widest text-center px-4",
				children: "NENHUM REGISTRO ENCONTRADO PARA OS FILTROS SELECIONADOS."
			})
		});
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "grid grid-cols-7 h-full border border-slate-200 rounded-xl bg-white overflow-hidden shadow-sm",
			children: [[
				"Dom",
				"Seg",
				"Ter",
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					className: cn("min-h-[120px] p-2 border-r border-b border-slate-100 hover:bg-slate-50 cursor-pointer transition-colors flex flex-col gap-1", !isSameMonth(d, currentDate) && "bg-slate-50/30 opacity-60"),
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: cn("text-sm font-bold mb-1 w-8 h-8 flex items-center justify-center rounded-full ml-auto", isSameDay(d, /* @__PURE__ */ new Date()) && "bg-[#1A233A] text-white"),
						children: format(d, "d")
					}), filters.showBookings && dayBookings.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "text-[10px] bg-[#1A233A]/10 text-[#1A233A] px-2 py-1 rounded font-bold truncate border border-[#1A233A]/10 uppercase text-center",
						children: [
							dayBookings.length,
							" Reserva",
	...
	const days = view === "day" ? [currentDate] : Array.from({ length: 7 }).map((_, i) => addDays(startOfWeek(currentDate, { weekStartsOn: 0 }), i));
	if (!days.some((d) => {
		const dateStr = format(d, "yyyy-MM-dd");
		const dayBookings = visibleBookings.filter((b) => b.booking_date === dateStr);
		const hasBlocks = generateTimeSlots(settings.find((s) => s.day_of_week === getDay(d))).some((slot) => checkBlockOverlap(slot.start, slot.end, dateStr, visibleBlocks));
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: cn("flex flex-col flex-1 min-h-[500px] bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm"),
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: cn("flex border-b border-slate-200 bg-slate-50/50", view === "week" && "divide-x divide-slate-100"),
			children: days.map((d, i) => {
				const isToday = isSameDay(d, /* @__PURE__ */ new Date());
				return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex-1 p-3 text-center min-w-[120px]",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: cn("text-[10px] font-black uppercase tracking-widest", isToday ? "text-[#1A233A]" : "text-slate-400"),
						children: format(d, "EEEE", { locale: ptBR })
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: cn("text-2xl font-black mt-0.5", isToday ? "text-[#1A233A]" : "text-slate-800"),
						children: format(d, "dd")
					})]
				}, i);
			})
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "flex-1 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] flex",
			children: days.map((d, i) => {
				const dateStr = format(d, "yyyy-MM-dd");
				const dayBookings = visibleBookings.filter((b) => b.booking_date === dateStr);
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: cn("flex-1 min-w-[120px] flex flex-col", view === "week" && "border-r border-slate-100 last:border-0"),
					children: !setting?.is_available ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "h-full flex flex-col items-center justify-center p-4 bg-slate-50/30",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "text-[10px] text-slate-400 font-bold uppercase tracking-widest bg-slate-100 px-3 py-1 rounded-full",
							children: "Fechado"
						})
					}) : slots.length === 0 ? null : slots.map((slot, sIdx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SlotItem, {
						slot,
						dateStr,
...
function ScanService() {
	...
	const [activeTab, setActiveTab] = (0, import_react.useState)("PARA MIM");
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					...
					children: [
						isAdmin && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							variant: "outline",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserMinus, { className: "w-4 h-4" }), " Nova Ausência"]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
...
//# sourceMappingURL=ScanService-BAghtoGS.js.map