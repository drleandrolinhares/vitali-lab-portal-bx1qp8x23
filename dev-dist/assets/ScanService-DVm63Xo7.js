import { t as Calendar$1 } from "./calendar-CQY1i0FS.js";
import { a as SelectValue, i as SelectTrigger, n as SelectContent, r as SelectItem, t as Select } from "./select-DEVFwjNT.js";
import { c as endOfMonth, d as addDays, f as ChevronLeft, i as isBefore, l as isSameDay, n as subDays, o as endOfWeek, r as isSameMonth, s as startOfMonth, t as Calendar, u as addWeeks } from "./calendar-Dy844ctt.js";
...
import { t as Trash2 } from "./trash-2-znIbXvsG.js";
import { A as startOfISOWeek, B as supabase, C as enUS, Et as toast, F as constructFrom, I as millisecondsInHour, It as require_react, L as millisecondsInMinute, M as getDefaultOptions$1, N as addMonths, P as toDate, R as millisecondsInSecond, S as getISOWeek, St as require_jsx_runtime, _ as isProtectedWeekYearToken, a as useAppStore, b as getWeek, g as isProtectedDayOfYearToken, h as format, j as startOfWeek, k as getTimezoneOffsetInMilliseconds, kt as Navigate, m as subMonths, p as ptBR, t as Button, tt as cn, v as warnOrThrowProtectedError, x as getWeekYear, y as longFormatters, zt as __toESM } from "./index-DQXy234v.js";
import { a as CardHeader, n as CardContent, o as CardTitle, t as Card } from "./card-0CSPNzov.js";
import { t as Input } from "./input-CU5mGn_a.js";
import { t as Label } from "./label-TA1G2SYQ.js";
import "./es2015-DczLHeSc.js";
import { a as DialogHeader, i as DialogFooter, n as DialogContent, o as DialogTitle, r as DialogDescription, t as Dialog } from "./dialog-DctOmr7p.js";
...
import { i as TabsTrigger, r as TabsList, t as Tabs } from "./tabs-CnI9bKwT.js";
...
function ScanSidebar({ currentDate, setCurrentDate, filters, setFilters }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "w-full lg:w-[300px] shrink-0 flex flex-col gap-4",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
			className: "border-border/60 shadow-sm overflow-hidden",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardContent, {
				className: "p-0 flex justify-center bg-background",
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardHeader, {
				className: "pb-3 pt-4 px-4 bg-muted/20 border-b border-border/50",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardTitle, {
					className: "text-sm uppercase font-bold text-muted-foreground",
					children: "Visibilidade"
				})
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardContent, {
				className: "p-4 space-y-4",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center space-x-3 bg-primary/5 p-3 rounded-md border border-primary/10",
					...
					className: "flex items-center space-x-3 bg-muted p-3 rounded-md border border-border",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Checkbox, {
						id: "show-blocks",
...
function ScanHeader({ view, setView, currentDate, setCurrentDate, isAdmin, onNewBooking, onNewBlock, onOpenSettings }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "flex flex-col xl:flex-row xl:items-center justify-between gap-4 p-4 border-b bg-background shrink-0",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "flex flex-wrap items-center gap-2 sm:gap-4",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center rounded-md border border-border bg-muted/20",
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-px h-5 bg-border" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							variant: "ghost",
							size: "icon",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					className: "text-lg sm:text-xl font-bold capitalize tabular-nums text-foreground tracking-tight ml-2",
...
function SlotItem({ slot, dateStr, bookings, blocks, filters, isStaff, currentUserId, onSlotClick, onBookingClick }) {
	...
	if (overlappingBlock && filters.showBlocks) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "text-[10px] p-2 rounded-md shadow-sm bg-slate-100 text-slate-500 border border-slate-300 border-dashed flex items-center justify-center text-center font-bold uppercase leading-tight cursor-not-allowed opacity-90",
		children: [
			"Bloqueado",
	...
	if (overlappingBooking && filters.showBookings) {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			className: cn("text-xs p-2 rounded-md border shadow-sm select-none transition-colors relative group", canViewDetails ? "bg-primary/10 text-primary-foreground border-primary/20 cursor-pointer hover:bg-primary/20" : "bg-muted text-muted-foreground border-border cursor-not-allowed opacity-80"),
...
function ScanCalendarViews({ view, currentDate, bookings, blocks, settings, filters, isStaff, currentUserId, onSlotClick, onBookingClick, setCurrentDate, setView }) {
	if (view === "month") {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "grid grid-cols-7 h-full border-l border-t border-border/50 bg-background min-w-[600px] lg:min-w-0",
			children: [[
				"Dom",
				"Seg",
				"Ter",
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					className: cn("min-h-[120px] p-2 border-r border-b border-border/50 hover:bg-muted/10 cursor-pointer transition-colors flex flex-col gap-1", !isSameMonth(d, currentDate) && "opacity-40 bg-muted/5"),
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: cn("text-sm font-bold mb-1 w-8 h-8 flex items-center justify-center rounded-full ml-auto", isSameDay(d, /* @__PURE__ */ new Date()) && "bg-primary text-primary-foreground"),
						children: format(d, "d")
					}), filters.showBookings && dayBookings.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "text-[10px] bg-primary/10 text-primary px-2 py-1 rounded font-bold truncate border border-primary/10",
						children: [
							dayBookings.length,
							" Reserva",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: cn("flex flex-1 min-h-0 min-w-[800px] lg:min-w-0 bg-background border border-border/50 rounded-lg overflow-hidden", view === "week" && "divide-x divide-border/50"),
		children: days.map((d, i) => {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: cn("p-3 text-center border-b border-border/50", isToday ? "bg-primary/10 border-primary/20" : "bg-muted/20"),
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: cn("text-xs font-bold uppercase", isToday ? "text-primary" : "text-muted-foreground"),
						children: format(d, "EEEE", { locale: ptBR })
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: cn("text-xl font-black mt-0.5", isToday ? "text-primary" : "text-foreground"),
						children: format(d, "dd")
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "flex-1 p-2 space-y-2 overflow-y-auto",
					children: !setting?.is_available ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "h-full flex flex-col items-center justify-center text-xs text-muted-foreground uppercase text-center opacity-50 p-4 font-bold border-2 border-dashed border-border rounded-lg bg-muted/10 min-h-[100px]",
						children: "Fechado"
...
function ScanService() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "flex flex-col lg:flex-row h-full min-h-[calc(100vh-6rem)] gap-4 md:gap-6 p-4 md:p-6 max-w-[1600px] mx-auto animate-fade-in pb-12",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScanSidebar, {
				currentDate,
				setCurrentDate,
				filters,
				setFilters
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex-1 flex flex-col min-w-0 bg-background rounded-xl border shadow-subtle overflow-hidden relative",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScanHeader, {
					...
					className: "flex-1 overflow-x-auto overflow-y-hidden bg-muted/5 flex flex-col min-h-0",
					children: loading ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ScanCalendarViews, {
							view,
							currentDate,
							bookings,
							blocks,
...
//# sourceMappingURL=ScanService-DVm63Xo7.js.map