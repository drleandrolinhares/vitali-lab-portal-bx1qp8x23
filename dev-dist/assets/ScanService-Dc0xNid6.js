import { t as Calendar$1 } from "./calendar-BL0rTo3_.js";
import { a as SelectValue, i as SelectTrigger, n as SelectContent, r as SelectItem, t as Select } from "./select-CHfCOgzS.js";
import { c as endOfMonth, d as addDays, i as isBefore, l as isSameDay, n as CalendarDayButton, o as endOfWeek, r as isSameMonth, s as startOfMonth, t as Calendar, u as addWeeks } from "./calendar-DAL_bDnW.js";
import { t as Clock } from "./clock-DBtwbOwe.js";
import { t as Funnel } from "./funnel-CHt3RtfH.js";
...
import { A as startOfISOWeek, B as supabase, C as enUS, Et as toast, F as constructFrom, I as millisecondsInHour, It as require_react, L as millisecondsInMinute, M as getDefaultOptions$1, P as toDate, R as millisecondsInSecond, S as getISOWeek, St as require_jsx_runtime, _ as isProtectedWeekYearToken, a as useAppStore, at as createLucideIcon, b as getWeek, g as isProtectedDayOfYearToken, h as format, j as startOfWeek, k as getTimezoneOffsetInMilliseconds, kt as Navigate, p as ptBR, t as Button, tt as cn, v as warnOrThrowProtectedError, x as getWeekYear, y as longFormatters, zt as __toESM } from "./index-Cm144OmE.js";
import { n as CardContent, t as Card } from "./card-DsazUj-d.js";
import { t as Input } from "./input-DS5QoKNy.js";
import { t as Label } from "./label-DKWVGlBv.js";
import "./es2015-CuA1jgg4.js";
import { a as DialogHeader, i as DialogFooter, n as DialogContent, o as DialogTitle, r as DialogDescription, t as Dialog } from "./dialog-B0GbhHxB.js";
import { n as DropdownMenuCheckboxItem, r as DropdownMenuContent, s as DropdownMenuTrigger, t as DropdownMenu } from "./dropdown-menu-Djy_RSJS.js";
import { n as PopoverContent, r as PopoverTrigger, t as Popover } from "./popover-BKQhfqZH.js";
...
import { t as Textarea } from "./textarea-Cz11DP1J.js";
...
const checkBlockOverlap = (slotStart, slotEnd, dateStr, blocks) => {
	return blocks.find((b) => {
		...
		const targetDate = /* @__PURE__ */ new Date(dateStr + "T12:00:00");
		if (b.recurrence === "weekly") {
			if (b.day_of_week !== null && b.day_of_week !== void 0) {
				if (targetDate.getDay() === b.day_of_week) return true;
			} else if (b.block_date) {
				const blockDate = /* @__PURE__ */ new Date(b.block_date + "T12:00:00");
...
const checkBookingOverlap = (start, end, date, bookings, excludeId) => {
	return bookings.filter((b) => b.booking_date.substring(0, 10) === date && b.id !== excludeId).some((b) => b.start_time.substring(0, 5) < end && b.end_time.substring(0, 5) > start);
};
...
function ScanSidebar({ currentDate, setCurrentDate, onDateSelect, bookings, isStaff, currentUserId, filters }) {
	const visibleBookingsForDots = (0, import_react.useMemo)(() => {
	...
	const CustomDayButton = (0, import_react.useMemo)(() => {
		const Component = import_react.forwardRef((props, ref) => {
			...
			const dayBookings = dateStr ? visibleBookingsForDots.filter((b) => b.booking_date.substring(0, 10) === dateStr).sort((a, b) => a.start_time.localeCompare(b.start_time)) : [];
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CalendarDayButton, {
				ref,
				day,
				modifiers,
				className: cn(className, "relative overflow-hidden flex flex-col items-center justify-start h-10 pt-1.5 group"),
				...rest,
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "relative z-10 leading-none",
					children: props.children
				}), dayBookings.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-auto mb-1 flex gap-[3px] flex-wrap justify-center w-full px-1",
					children: [dayBookings.slice(0, 3).map((b) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: cn("h-1.5 w-1.5 rounded-full opacity-90 transition-colors", canViewDetails ? colors[charCode % colors.length] : "bg-slate-300") }, b.id);
					}), dayBookings.length > 3 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-1.5 w-1.5 rounded-full bg-slate-300 opacity-90 transition-colors" })]
				})]
			});
		});
...
function ScanCalendarViews({ view, currentDate, bookings, blocks, settings, filters, isStaff, currentUserId, activeTab, onSlotClick, onBookingClick }) {
	...
	if (activeTab === "AGENDAMENTOS MARCADOS") {
		if (isStaff) {
			const grouped = [...visibleBookings].sort((a, b) => {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: sortedDates.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
				...
				}) : sortedDates.map((date) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "bg-slate-50 border-b border-slate-200 px-4 py-3 font-black text-sm uppercase tracking-wider text-[#1A233A]",
						children: format(/* @__PURE__ */ new Date(date + "T12:00:00"), "EEEE, dd 'de' MMMM", { locale: ptBR })
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Table, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHeader, {
						className: "bg-slate-50/50",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
								className: "font-bold text-[10px] uppercase tracking-wider text-slate-500 w-[140px]",
								children: "Horário"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
								className: "font-bold text-[10px] uppercase tracking-wider text-slate-500",
								children: "Dentista"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
								className: "font-bold text-[10px] uppercase tracking-wider text-slate-500",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHead, {
								className: "font-bold text-[10px] uppercase tracking-wider text-slate-500 text-center w-[120px]",
								children: "Status"
							})
						] })
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableBody, { children: grouped[date].map((b) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
								className: "font-black text-[#1A233A]",
								children: b.patient_name
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableCell, {
								className: "text-center",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider bg-emerald-100 text-emerald-700",
									children: "CONFIRMADO"
								})
							})
						]
		...
		const dayBookings = visibleBookings.filter((b) => b.booking_date.substring(0, 10) === selectedDateStr).sort((a, b) => a.start_time.localeCompare(b.start_time));
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: format(/* @__PURE__ */ new Date(b.booking_date.substring(0, 10) + "T12:00:00"), "MMM", { locale: ptBR })
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "text-lg font-black leading-none",
							children: format(/* @__PURE__ */ new Date(b.booking_date.substring(0, 10) + "T12:00:00"), "dd")
						})]
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: calendarDays.map((d) => {
					...
					const dayBookings = timelineBookings.filter((b) => b.booking_date.substring(0, 10) === dateStr).sort((a, b) => a.start_time.localeCompare(b.start_time));
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: dayBookings.map((b) => {
								...
								const charCode = b.id.charCodeAt(0) || 0;
								const colorClass = canViewDetails ? colors[charCode % colors.length] : "bg-[#E11D48] text-white cursor-not-allowed border border-[#BE123C]";
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									onClick: (e) => {
										e.stopPropagation();
										if (canViewDetails) onBookingClick(b);
									},
									className: cn("text-[9px] sm:text-[10px] font-bold px-1.5 py-0.5 rounded truncate transition-colors shadow-sm", canViewDetails ? "cursor-pointer" : "", colorClass),
									title: `${b.start_time.substring(0, 5)} - ${canViewDetails ? b.patient_name : "INDISPONÍVEL"}`,
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: cn("mr-1 font-semibold", canViewDetails ? "opacity-75" : "opacity-90"),
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: days.map((d) => {
			const dateStr = format(d, "yyyy-MM-dd");
			const dayBookings = timelineBookings.filter((b) => b.booking_date.substring(0, 10) === dateStr);
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: !setting?.is_available ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						const isTargetDentist = isStaff && filters.dentistId && filters.dentistId !== "all" ? overlapBooking?.dentist_id === filters.dentistId : true;
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: overlapBlock ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "bg-[#E11D48] border-[#BE123C] text-white shadow-sm h-10 px-4 rounded-lg flex items-center justify-center font-bold text-xs uppercase tracking-widest cursor-not-allowed",
									...
									className: cn("h-auto min-h-[40px] py-2 px-4 rounded-lg border flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-4 transition-colors", isVisibleForUser ? "bg-[#E11D48]/5 border-[#E11D48]/20 cursor-pointer hover:bg-[#E11D48]/10" : canViewDetails ? "bg-slate-100 border-slate-200 opacity-80 cursor-pointer hover:bg-slate-200" : "bg-[#E11D48] border-[#BE123C] text-white cursor-not-allowed shadow-sm"),
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: cn("font-bold text-sm truncate", isVisibleForUser ? "text-[#E11D48]" : canViewDetails ? "text-slate-600" : "text-white tracking-widest"),
										children: canViewDetails ? overlapBooking.patient_name : "INDISPONÍVEL"
									}), canViewDetails && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: cn("text-xs font-bold truncate", isVisibleForUser ? "text-[#E11D48]/70" : "text-slate-500"),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							form.recurrence === "weekly" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "space-y-2 col-span-2 sm:col-span-1",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
									className: "uppercase text-[10px] font-bold",
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							children: [
								b.recurrence,
								" ",
								b.recurrence === "weekly" && b.day_of_week !== null && b.day_of_week !== void 0 ? `- ${[
									"DOM",
									"SEG",
									"TER",
									"QUA",
									...
									"SEX",
									"SÁB"
								][b.day_of_week]}` : b.block_date ? format(/* @__PURE__ */ new Date(b.block_date + "T00:00:00"), "dd/MM/yyyy") : ""
							]
						})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							variant: "ghost",
							size: "icon",
...
function ScanService() {
	...
	const [blockForm, setBlockForm] = (0, import_react.useState)({
		...
		day_of_week: (/* @__PURE__ */ new Date()).getDay().toString(),
		start_time: "08:00",
		end_time: "12:00",
		recurrence: "unique"
	});
	...
	const handleSaveBooking = async () => {
		...
		setSaving(true);
		const formattedStart = formData.start_time.length === 5 ? `${formData.start_time}:00` : formData.start_time;
		const formattedEnd = formData.end_time.length === 5 ? `${formData.end_time}:00` : formData.end_time;
		let overlapQuery = supabase.from("scan_service_bookings").select("id").eq("booking_date", formData.booking_date).lt("start_time", formattedEnd).gt("end_time", formattedStart);
		if (modal.mode === "edit" && modal.booking?.id) overlapQuery = overlapQuery.neq("id", modal.booking.id);
	...
	const handleAddBlock = async () => {
		if (blockForm.recurrence === "unique" || blockForm.recurrence === "monthly") {
			if (!blockForm.block_date) return toast({
		...
		const { error } = await supabase.from("scan_service_blocks").insert({
			...
			block_date: blockForm.recurrence === "unique" || blockForm.recurrence === "monthly" ? blockForm.block_date : null,
...
//# sourceMappingURL=ScanService-Dc0xNid6.js.map