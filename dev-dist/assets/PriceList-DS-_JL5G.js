import { t as Calculator } from "./calculator-Cu74zW7f.js";
import { n as TrendingDown, r as ChartPie, t as TrendingUp } from "./trending-up-5an6Lmuv.js";
...
import { n as Root$1, r as createRovingFocusGroupScope, t as Item } from "./dist-C_l7PIGc.js";
...
function PriceList() {
	...
	const fetchPrices = async () => {
		setLoading(true);
		const { data } = await supabase.from("price_list").select("*, price_stages(*)").order("work_type", { ascending: true });
	...
	const handleFormChange = (field, value) => {
		...
		if (hasAttemptedSubmit || formErrors[field]) {
			...
			else if (field !== "is_hidden" && typeof value === "string") setFormErrors((prev) => ({
				...prev,
				[field]: !value.trim()
			}));
		}
	...
	const handleFormBlur = (field) => {
		...
		else if (field !== "is_hidden") setFormErrors((prev) => ({
			...prev,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex-1 flex items-center gap-2 w-full sm:max-w-xs relative",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Search, { className: "w-4 h-4 text-muted-foreground absolute left-3" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Funnel, { className: "w-4 h-4 text-muted-foreground" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "hidden sm:inline",
							children: "Filtrar por Margem:"
						})]
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardContent, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Table, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TableHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableRow, { children: [
						...
						colSpan: 7,
						className: "h-32 text-center text-muted-foreground",
						children: prices.length > 0 && (profitFilter.length > 0 || searchQuery) ? "Nenhum procedimento encontrado para os filtros selecionados." : "Nenhum procedimento encontrado."
							...
							children: [
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												}), item.is_hidden && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
													variant: "outline",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TableCell, {
									...
									children: [
										...
										(currentUser?.role === "master" || currentUser?.role === "admin") && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
											variant: "ghost",
											size: "icon",
											className: "h-7 w-7",
											onClick: () => handleDuplicate(item),
											title: "Duplicar",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Copy, { className: "w-3.5 h-3.5 text-muted-foreground" })
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
											variant: "ghost",
											size: "icon",
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "space-y-2",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "Estrutura de Fixação" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
										...
										currentUser?.role === "master" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "space-y-2 col-span-2 flex flex-row items-center justify-between rounded-lg border p-4 bg-muted/20 mt-2",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "space-y-0.5",
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, {
													className: "text-base font-semibold text-destructive",
													children: "PROCEDIMENTO OCULTO"
												}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
													className: "text-sm text-muted-foreground",
													children: "Este procedimento será usado apenas para testes e ficará invisível para os demais usuários."
												})]
...
//# sourceMappingURL=PriceList-DS-_JL5G.js.map