import { t as Calendar$1 } from "./calendar-CVsOw_NT.js";
import { a as SelectValue, i as SelectTrigger, n as SelectContent, r as SelectItem, t as Select } from "./select-BU5h-lV5.js";
import { a as startOfMonth, c as addWeeks, i as endOfWeek, l as addDays, n as isBefore, o as endOfMonth, s as isSameDay, t as Calendar } from "./calendar-f5DXYEnM.js";
import { t as Clock } from "./clock-UWhUhnHT.js";
import { t as Funnel } from "./funnel-BPNAbZm_.js";
...
import { t as Trash2 } from "./trash-2-D98MFr4l.js";
import { t as User } from "./user-D2Jlw_VC.js";
import { t as parseISO } from "./parseISO-c1q7NeT_.js";
import { A as startOfISOWeek, B as supabase, C as enUS, D as startOfDay, Et as toast, F as constructFrom, I as millisecondsInHour, It as require_react, L as millisecondsInMinute, M as getDefaultOptions$1, P as toDate, R as millisecondsInSecond, S as getISOWeek, St as require_jsx_runtime, _ as isProtectedWeekYearToken, a as useAppStore, at as createLucideIcon, b as getWeek, g as isProtectedDayOfYearToken, h as format, j as startOfWeek, k as getTimezoneOffsetInMilliseconds, kt as Navigate, p as ptBR, t as Button, tt as cn, v as warnOrThrowProtectedError, x as getWeekYear, y as longFormatters, zt as __toESM } from "./index-RFqS_88P.js";
import { n as CardContent, t as Card } from "./card-BnZBfBPD.js";
import { t as Input } from "./input-DXJHy-U0.js";
import { t as Label } from "./label-uaPzgkKf.js";
import "./es2015-BHLMgIXl.js";
import { a as DialogHeader, i as DialogFooter, n as DialogContent, o as DialogTitle, r as DialogDescription, t as Dialog } from "./dialog-9ky6n9Jp.js";
import { n as DropdownMenuCheckboxItem, r as DropdownMenuContent, s as DropdownMenuTrigger, t as DropdownMenu } from "./dropdown-menu-BZi61amO.js";
import { n as PopoverContent, r as PopoverTrigger, t as Popover } from "./popover-Dqb9EBFX.js";
import { t as Switch } from "./switch-B3qo9BD1.js";
import { t as Textarea } from "./textarea-CY0L2h_I.js";
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DropdownMenu, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DropdownMenuTrigger, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SelectTrigger, {
						className: "w-full sm:w-[220px] h-11 text-xs font-bold uppercase border-slate-200 bg-white",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(User, { className: "w-4 h-4 mr-2 text-slate-400" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectValue, { placeholder: "POR DENTISTAS" })]
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: ["VISÃO GERAL", "AGENDAMENTOS MARCADOS"].map((tab) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					onClick: () => setActiveTab(tab),
					className: cn("px-5 pb-3 pt-4 text-[11px] whitespace-nowrap font-black uppercase border-b-[3px] transition-colors tracking-wide", activeTab === tab ? "border-[#E11D48] text-[#1A233A]" : "border-transparent text-slate-400 hover:text-slate-600 hover:border-slate-200"),
					children: tab
				}, tab))
			})
		})]
...
function ScanCalendarViews({ view, currentDate, bookings, blocks, settings, filters, isStaff, currentUserId, activeTab, onSlotClick, onBookingClick }) {
	...
	if (activeTab === "AGENDAMENTOS MARCADOS") {
		...
		const futureBookings = visibleBookings.filter((b) => {
			return !isBefore(parseISO(b.booking_date + "T00:00:00"), today);
		}).sort((a, b) => a.booking_date.localeCompare(b.booking_date) || a.start_time.localeCompare(b.start_time));
		if (futureBookings.length === 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: futureBookings.map((b) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: days.map((d) => {
			...
			if (view === "month" && slots.length > 0) {
				if (!slots.some((slot) => checkBlockOverlap(slot.start, slot.end, dateStr, blocks) || dayBookings.find((b) => b.start_time.substring(0, 5) < slot.end && b.end_time.substring(0, 5) > slot.start)) && !isSameDay(d, currentDate)) return null;
			}
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function ScanService() {
	...
	const [activeTab, setActiveTab] = (0, import_react.useState)("VISÃO GERAL");
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					...
					children: [
						...
						isMaster && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							variant: "outline",
...
//# sourceMappingURL=ScanService-Dd6D3cn4.js.map