import { t as Calendar$1 } from "./calendar-CQs9zMSD.js";
import { a as SelectValue, i as SelectTrigger, n as SelectContent, r as SelectItem, t as Select } from "./select-nC3wGjX5.js";
import { c as endOfMonth, d as addDays, i as isBefore, l as isSameDay, n as CalendarDayButton, o as endOfWeek, r as isSameMonth, s as startOfMonth, t as Calendar, u as addWeeks } from "./calendar-CxXQdUkg.js";
import { t as Clock } from "./clock-DaK-TiQ-.js";
import { t as Funnel } from "./funnel-C4JBib_D.js";
...
import { t as Trash2 } from "./trash-2-Ce-p2svQ.js";
import { t as User } from "./user-SnKpHO8r.js";
import { A as startOfISOWeek, B as supabase, C as enUS, Et as toast, F as constructFrom, I as millisecondsInHour, It as require_react, L as millisecondsInMinute, M as getDefaultOptions$1, P as toDate, R as millisecondsInSecond, S as getISOWeek, St as require_jsx_runtime, _ as isProtectedWeekYearToken, a as useAppStore, at as createLucideIcon, b as getWeek, g as isProtectedDayOfYearToken, h as format, j as startOfWeek, k as getTimezoneOffsetInMilliseconds, kt as Navigate, p as ptBR, t as Button, tt as cn, v as warnOrThrowProtectedError, x as getWeekYear, y as longFormatters, zt as __toESM } from "./index-n4619bSt.js";
import { n as CardContent, t as Card } from "./card-CISi8zNV.js";
import { t as Input } from "./input-DlJFFz8p.js";
import { t as Label } from "./label-C6RFESgO.js";
import "./es2015-DdAGf8WF.js";
import { a as DialogHeader, i as DialogFooter, n as DialogContent, o as DialogTitle, r as DialogDescription, t as Dialog } from "./dialog-BrLVQyEs.js";
import { n as DropdownMenuCheckboxItem, r as DropdownMenuContent, s as DropdownMenuTrigger, t as DropdownMenu } from "./dropdown-menu-D8awZX6d.js";
import { n as PopoverContent, r as PopoverTrigger, t as Popover } from "./popover-DXkMHyvl.js";
import { t as Switch } from "./switch-h_ZLsp7Y.js";
import { t as Textarea } from "./textarea-C8KkDhfL.js";
...
function ScanSidebar({ currentDate, setCurrentDate, onDateSelect, bookings, isStaff, currentUserId, filters }) {
	...
	const CustomDayButton = (0, import_react.useMemo)(() => {
		const Component = import_react.forwardRef((props, ref) => {
			...
			const dayBookings = dateStr ? visibleBookings.filter((b) => b.booking_date.substring(0, 10) === dateStr).sort((a, b) => a.start_time.localeCompare(b.start_time)) : [];
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CalendarDayButton, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					children: [dayBookings.slice(0, 3).map((b) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: cn("h-1.5 w-1.5 rounded-full opacity-90 transition-colors", colorClass) }, b.id);
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: calendarDays.map((d) => {
					...
					const dayBookings = visibleBookings.filter((b) => b.booking_date.substring(0, 10) === dateStr).sort((a, b) => a.start_time.localeCompare(b.start_time));
...
//# sourceMappingURL=ScanService-C9ummbRz.js.map